...
require (
	...
	go.opentelemetry.io/collector/connector/connectortest v0.132.1-0.20250814180350-eb9588bb3b55
...
require (
	...
	github.com/DataDog/agent-payload/v5 v5.0.164-0.20250825105931-eb8135d7d179 // indirect
