...
| [Code Owners](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/CONTRIBUTING.md#becoming-a-code-owner)    | [@dmitryax](https://www.github.com/dmitryax), [@hvaghani221](https://www.github.com/hvaghani221), [@TylerHelmuth](https://www.github.com/TylerHelmuth), [@ChrsMark](https://www.github.com/ChrsMark), [@krisztianfekete](https://www.github.com/krisztianfekete) |
...
- `storage` (default: none): specifies the storage extension to use for persisting resourceVersions. Only takes effect when `include_initial_state: true` is set on a watch-mode object. After a restart, the receiver uses the persisted resourceVersion to skip initial-state `ADDED` events for objects it has already emitted. Pull-mode objects are unaffected.
